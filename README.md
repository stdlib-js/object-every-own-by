...
```javascript
import everyOwnBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/object-every-own-by@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/object-every-own-by/tags). For example,

```javascript
import everyOwnBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/object-every-own-by@v0.1.0-deno/mod.js';
```
...
[@stdlib/object/none-own-by]: https://github.com/stdlib-js/object-none-own-by/tree/deno

[@stdlib/object/some-own-by]: https://github.com/stdlib-js/object-some-own-by/tree/deno
