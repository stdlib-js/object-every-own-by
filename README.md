...
```javascript
everyOwnBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-every-own-by@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/object-every-own-by/tags). For example,

```javascript
everyOwnBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-every-own-by@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var everyOwnBy = require( 'path/to/vendor/umd/object-every-own-by/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/object-every-own-by@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/object-every-own-by.svg
[npm-url]: https://npmjs.org/package/@stdlib/object-every-own-by

[test-image]: https://github.com/stdlib-js/object-every-own-by/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/object-every-own-by/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/object-every-own-by/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/object-every-own-by?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/object-every-own-by.svg
[dependencies-url]: https://david-dm.org/stdlib-js/object-every-own-by/main
...
[branches-url]: https://github.com/stdlib-js/object-every-own-by/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/object-every-own-by/main/LICENSE
...
[@stdlib/object/none-own-by]: https://github.com/stdlib-js/object-none-own-by/tree/umd

[@stdlib/object/some-own-by]: https://github.com/stdlib-js/object-some-own-by/tree/umd
